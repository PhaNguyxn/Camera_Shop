...
function Home(props) {
                    ...
                    <section className="hero pb-3 bg-cover bg-center d-flex align-items-center" style={{ backgroundImage: `url(${Image.banner})` }}>
                        <div className="container py-5">
                            <div className="row px-4 px-lg-5">
                                <div className="col-lg-6">
                                    <p className="text-muted small text-uppercase mb-2">New Inspiration 2026</p>
                                    <h1 className="h2 text-uppercase mb-3">20% off on new season</h1><a className="btn btn-dark" href="/shop">Buy Now!</a>
                                </div>
                            </div>
                        </div>
                    </section>
    ...
    <div className="col-md-4 mb-4">
        <Link className="category-item" to={'/shop'}>
            <img className="img-fluid" src={Image.img1} alt="Mirrorless" />
            <strong className="category-item-title">Mirrorless</strong>
        </Link>
    </div>
    <div className="col-md-4 mb-4">
        <Link className="category-item" to={'/shop'}>
            <img className="img-fluid" src={Image.img2} alt="Film" />
            <strong className="category-item-title">Film</strong>
        </Link>
    </div>
    <div className="col-md-4 mb-4">
        <Link className="category-item" to={'/shop'}>
            <img className="img-fluid" src={Image.img4} alt="Action" />
    ...
    <div className="col-md-6 mb-4">
        <Link className="category-item" to={'/shop'}>
            <img className="img-fluid" src={Image.img3} alt="Compact" />
            <strong className="category-item-title">Compact</strong>
        </Link>
    </div>
    <div className="col-md-6 mb-4">
        <Link className="category-item" to={'/shop'}>
            <img className="img-fluid" src={Image.img5} alt="DSLR" />
                                                ...
                                                <div className="product-overlay">
                                                    <ul className="mb-0 list-inline">
                                                        ...
                                                        <li className="list-inline-item mr-0">
                                                            {/* Dùng Modal phải có href để nó hiện ra và thuộc tính data-toggle="modal" để mở modal*/}
